...
public class InheritanceExample7 {
	...
	public static void main(String[] args) {
		...
		CheckingAccount obj2 =new CheckingAccount("444-55-6666", "홍길동", 20000,"5555-6666-7777-8888");
		CreditLineAccount obj3 =new CreditLineAccount("777-88-999999", "김선달", 30000, 200000);
