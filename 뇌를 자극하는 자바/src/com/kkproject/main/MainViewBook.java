...
/* ---------- managementMain 설정 시작 ---------- */
public class  MainViewBook extends JFrame {

	private MainProcessBook main;
...
/* ---------- frame setting 시작 ---------- */
	public MainViewBook() {
		System.out.println("MainViewBook() 생성자");
...
/* ---------- panel setting 시작 ---------- */
	public void placeLoginPanel(JPanel panel) {
		...
		JLabel memberManagement = new JLabel("Book Management");
		memberManagement.setForeground(Color.WHITE);
		memberManagement.setBounds(28, 110, 125, 20);
		...
		/* table setting 시작 */
		String colNames[] = {"Code", "Name", "Publisher", "Writer", "Count"};
		Object data [][] = {{"", "", "", "", ""}};
...
/* ---------- panel setting 끝 ---------- */
	...
	public void setMain(MainProcessBook main) {
		this.main = main;
	}
